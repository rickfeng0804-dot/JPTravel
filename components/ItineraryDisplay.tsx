                ...
                <div className="p-6 md:p-8 relative">
                    ...
                    <div className="space-y-8">
                      {day.activities.map((act: Activity, idx) => {
                          ...
                          // Check if this activity is suitable for illustration (sightseeing, food, accommodation, shopping)
                          const showIllustration = ['sightseeing', 'food', 'accommodation', 'shopping'].includes(act.type);
                    ...
                    {/* Day Map Generator - Added at the bottom of the day list */}
                    <DayMapGenerator 
                      dayPlan={day} 
