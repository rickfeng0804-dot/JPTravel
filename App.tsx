...
// 更新 Logo 為日本地圖圖示
const LOGO_IMAGE_URL = "https://cdn-icons-png.flaticon.com/512/805/805368.png";
// 飛機圖示 (使用卡通風格飛機模擬旅遊氛圍)
      ...
      <div className="relative z-10 container mx-auto px-4 py-8 md:py-12">
        ...
        <header className="flex justify-center mb-12">
          <div className="flex items-center gap-3 cursor-pointer group" onClick={resetApp}>
            <div className="relative w-16 h-16 p-1 rounded-full overflow-hidden shadow-lg border-2 border-white rotate-3 group-hover:rotate-6 transition-transform z-10 bg-white">
              <img 
                src={LOGO_IMAGE_URL} 
                alt="Logo" 
